...
export default function MedicalRecyclingPage() {
  return (
    <div className="pt-[120px] pb-[100px] min-h-screen">
      <div className="container-page">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-[#3A3A3A] mb-8">
          杜邦全国青年创业大赛｜医疗废弃物回收项目
        </h1>
        
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden h-[600px] md:h-[800px]">
          <iframe 
            src="https://view.officeapps.live.com/op/embed.aspx?src=https://xiaxia-portfolio.vercel.app/projects/medical-recycling.pptx" 
            width="100%" 
            height="100%" 
            frameBorder="0"
          >
